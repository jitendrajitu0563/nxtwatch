        ...
        {value => {
          ...
          return (
            <>
              <Header />
              <NavigationBar />
              <div className="HomeContainer" data-testid="home" background-color={bgColor}>
                <div className="BannerContainer" data-testid="banner" display={display}>
                  <div className="BannerLeftPart">
                    ...
                    <button className="BannerButton" type="button">GET IT NOW</button>
                  </div>
                  <div className="BannerRightPart">
                    <button className="BannerCloseButton"
                      data-testid="close"
